...
-- Ajoute des contraintes NOT NULL et de longueur minimale
ALTER TABLE articles
  ...
  ADD CONSTRAINT link_length CHECK (length(link) >= 5),
  ADD CONSTRAINT source_length CHECK (length(source) >= 3);
