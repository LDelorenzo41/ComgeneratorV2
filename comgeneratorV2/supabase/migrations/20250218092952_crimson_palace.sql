/*
  # Correction finale de la fonction RSS

  1. Changements
    - Suppression complète de l'ancienne fonction
    - Recréation avec le bon type de retour
    - Ajout des permissions explicites

  2. Sécurité
    - SECURITY DEFINER pour exécuter avec les privilèges du propriétaire
    - Permissions explicites pour les utilisateurs authentifiés et anonymes
*/

-- Supprime l'ancienne fonction si elle existe
DROP FUNCTION IF EXISTS fetch_rss_articles();

-- Recrée la fonction avec le bon type de retour
...
-- Rafraîchir les permissions de la fonction
