...
BEGIN
  ...
  VALUES 
    -- Articles du Café Pédagogique (format: /lexpresso/Pages/YYYY/MM/JJ/titre.aspx)
    ('Les nouvelles méthodes d''enseignement en 2025', 
     ...
     'https://www.cafepedagogique.net/lexpresso/Pages/2024/02/18/nouvelles-methodes-enseignement-2025.aspx', 
     'Café Pédagogique', 
     NOW()),
    ...
    ('Réforme du baccalauréat 2025 : les changements majeurs', 
     ...
     'https://www.cafepedagogique.net/lexpresso/Pages/2024/02/18/reforme-baccalaureat-2025.aspx', 
     'Café Pédagogique', 
     NOW() - interval '1 hour'),
    
    ('Guide 2025 des outils numériques', 
     'Panorama des solutions technologiques innovantes pour la classe.', 
     'https://www.cafepedagogique.net/lexpresso/Pages/2024/02/18/guide-outils-numeriques-2025.aspx', 
     'Café Pédagogique', 
     NOW() - interval '2 hours'),
    
    -- Articles de VousNousIls (format: /YYYY/MM/JJ/titre-ID)
    ('L''intelligence artificielle au service de l''éducation', 
     ...
     'https://www.vousnousils.fr/2024/02/18/intelligence-artificielle-education-pedagogie-666123', 
     'VousNousIls', 
    ...
    ('Bien-être des élèves : nouvelles recommandations 2025', 
     ...
     'https://www.vousnousils.fr/2024/02/18/bien-etre-eleves-recommandations-666124', 
     'VousNousIls', 
