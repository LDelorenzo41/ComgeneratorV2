...
-- Recrée la fonction avec les bons formats d'articles
...
BEGIN
  ...
  -- Insérer des articles avec le bon format
  ...
  VALUES 
    ...
    ('Les nouvelles méthodes d''enseignement en 2025', 
     ...
     'https://www.cafepedagogique.net/lexpresso/Pages/2024/02/nouvelles-methodes-enseignement.aspx', 
     'Café Pédagogique', 
     NOW()),
    ...
    ('Réforme du baccalauréat 2025 : les changements majeurs', 
     ...
     'https://www.cafepedagogique.net/lexpresso/Pages/2024/02/reforme-baccalaureat-2025.aspx', 
     'Café Pédagogique', 
     NOW() - interval '1 hour'),
    
    ('Guide 2025 des outils numériques', 
     'Panorama des solutions technologiques innovantes pour la classe.', 
     'https://www.cafepedagogique.net/lexpresso/Pages/2024/02/guide-outils-numeriques-2025.aspx', 
     'Café Pédagogique', 
     NOW() - interval '2 hours'),
    
    -- Articles de VousNousIls
